...
namespace Trabalho.katia
{
    public partial class ProdutoForm2 : Form
    {
        ...
        {
            panel1.Visible = false;
            string parametros = $"insert into produto values('{txtid.Text}','{txtcodigo.Text}','{txtdescricao.Text}','{txtvalidade.Text}','{txt.Text}','{txtqtdestoque.Text}','{txttipo.Text}','{txtmedida.Text}')";
        ...
        private void btnpesquisar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                while (read.Read())
                {
                    ...
                    txt.Text = Convert.ToString(read["Preco"]);
        ...
        private void btnalterar_Click(object sender, EventArgs e)
        {
            ...
            string parametros = $"update produto set Codigo = '{txtcodigo.Text}',Descricao = '{txtdescricao.Text}',Validade = '{txtvalidade.Text}',Preco = '{txt.Text}',QtdEstoque = '{txtqtdestoque.Text}',Tipo = '{txttipo.Text}',Medida = '{txtmedida.Text}' where idproduto = '{txtid.Text}'" ;
            conectar.Comm(parametros);
        ...
        #region botao menu alimenticio
        private void btnalimenticio_Click(object sender, EventArgs e)
        {
            if (panel1.Visible.Equals(false))
            {
                panel1.Visible = true;
            }
            else
